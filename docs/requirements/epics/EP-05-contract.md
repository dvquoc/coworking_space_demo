...
**Nội dung hợp đồng**: Thông tin bên thuê/cho thuê, dịch vụ thuê (loại chỗ, thời gian, quyền lợi), giá & thanh toán, quy định sử dụng, trách nhiệm bồi thường, điều khoản chấm dứt.
...
4. Giá & thanh toán (monthly fee, deposit, payment cycle, late fee)
